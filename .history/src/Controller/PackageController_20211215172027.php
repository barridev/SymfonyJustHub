...
{
    #[
        Route('/packages', name: 'package_index', methods: ['GET']),
        IsGranted("ROLE_SENDER")
    ]
    ...
    public function create(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('green', "Le livre {$package->getName()} à bien été créé.");
    ...
    public function edit(Package $package, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('green', "Le livre {$package->getName()} à bien été édité.");
    ...
    public function delete(Package $package, $token): Response
    {
        if ($this->isCsrfTokenValid('delete_package', $token)) {
            ...
            $this->addFlash('green', "Le livre {$package->getName()} à bien été supprimé.");
