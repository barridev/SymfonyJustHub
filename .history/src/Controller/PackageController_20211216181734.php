...
class PackageController extends AbstractController
{
    ...
    {
        $senderUser = $this->getUser()->getUserSender()->getId();
        // $senderUser = $this->getUser()->getUserSender()->find($id);
        ...
        return $this->render('package/indexSender.html.twig', [
            ...
            $this->getUser()->getUserSender()->getId()
            $packageUser = $this->getUser()->getUserSender()->find($id);
